...
// ╔══════════════════════════════════════════════════════════════════════════╗
// ║  layer2_evil_zero.js  —  The LYING NODE (Byzantine Fault Demo)           ║
// ║                                                                          ║
// ║  This node behaves identically to layer2_webcam.js EXCEPT that it        ║
...
// ║                                                                          ║
// ║  Usage:                                                                  ║
// ║    node layer2_evil_zero.js B 5001                                       ║
// ╚══════════════════════════════════════════════════════════════════════════╝
...
// ─── CLI args (same convention as layer2_webcam.js) ─────────────────────────────
const _arg1 = process.argv[2];
const _arg2 = process.argv[3];
let NODE_NAME, PORT;
if (!_arg1) {
    NODE_NAME = 'EVIL-ZERO'; PORT = 5001;
...
async function init() {
    ...
    app.listen(PORT, async () => {
        console.log(`\n${'─'.repeat(60)}`);
        console.log(`  EVIL-ZERO Layer-2 Node [${NODE_NAME}] running on port ${PORT}`);
